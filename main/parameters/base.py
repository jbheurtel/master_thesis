...
class ParamLoader(Map):
    def __init__(self, id):
        ...
        conf = get_paths()
        params = pd.read_excel(conf.param_set, sheet_name='main')
        data_keys = pd.read_excel(conf.param_set, sheet_name='data_key')
        split_keys = pd.read_excel(conf.param_set, sheet_name='split_key')
